...
# The room number is displayed on the terminal upon execution. I've also put my ngrok token inside a file named ".ngrok_token.txt" which gets read by the initialization script. This is just a simple game for demonstration purposes.
